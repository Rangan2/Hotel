...
$name=$_GET['name'];
list($n,$e,$p)=explode("-",$name);
$new_arr=$p."/".$e."/".$n;
//echo $new_arr;
$edate=$_GET['edate'];
list($a,$b,$c)=explode("-",$edate);
$date_arr=$c."/".$b."/".$a;
//echo $date_arr;
$sql="select * from customer_booking where date >='$new_arr' and date <='$date_arr' ";
//echo $sql;
$rec=mysql_query($sql);
?>
    ...
    <td><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
	  ...
	  ?>
        <td align="center"><table width="95%" border="0">
          <tr bgcolor="#666666">
            <td width="7%" align="center"><span class="style1">Sl No </span></td>
            <td width="13%" align="center"><span class="style4">Check-In-Id</span></td>
            <td width="12%"><span class="style1">Guest Name </span></td>
            <td width="10%" align="center"><span class="style1">Address</span></td>
            ...
            <td width="10%" align="center"><span class="style1">Dep Date </span></td>
            <td width="8%" align="center"><span class="style1">Time</span></td>
            <td width="14%" align="center"><span class="style1">Tel No </span></td>
          </tr>
