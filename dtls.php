                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="check_in_header_row">
                      ...
                      <tr>
                        <td height="22"><table width="100%" border="0">
                          <tr>
                            <td width="18%" align="right"> Starting Date </td>
                            <td width="22%" align="left"><input name="sdate" type="date" id="sdate"   onchange="find_date()" /></td>
                            <td width="27%" align="right">Ending Date </td>
                            <td width="33%" align="left"><input name="edate" type="date" id="edate"  onchange="find_date()" /></td>
                          </tr>
                        </table></td>
                      </tr>
                      <tr>
